...
import '../../css/PersonalInfo.css';  // Asegúrate de importar tu archivo CSS
...
function PersonalInfo({ formData, setFormData }) {
  ...
  return (
    <div className="container custom-card-bg p-4 mb-4" style={{ backgroundColor: "#3EDBF0", borderRadius: '10px', boxShadow: '0 4px 8px rgba(0, 0, 0, 0.1)' }}>
      <div className="row">
